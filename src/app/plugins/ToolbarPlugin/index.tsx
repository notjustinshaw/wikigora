			...
			{blockType === "code" ? (
				...
				<>
					<button
						...
						className={"toolbar-item mr-[2px] " + (isBold ? "active" : "")}
					...
					<button
						...
						className={"toolbar-item mr-[2px] " + (isItalic ? "active" : "")}
					...
					<button
						...
						className={
							"toolbar-item mr-[2px] " + (isUnderline ? "active" : "")
						}
					...
					<button
						...
						className={
							"toolbar-item mr-[2px] " + (isStrikethrough ? "active" : "")
						}
					...
					<button
						...
						className={"toolbar-item mr-[2px] " + (isCode ? "active" : "")}
						aria-label='Insert Code'>
						<Code size={18} />
					</button>
					<button
						onClick={insertLink}
						className={"toolbar-item mr-[2px] " + (isLink ? "active" : "")}
...
function ToolbarItem({ onClick, label, image }: any) {
	return (
		<button
			onClick={() => onClick()}
			className='toolbar-item'
